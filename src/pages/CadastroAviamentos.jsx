  ...
  return (
    <>
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '32px', animation: 'fadeInDown 0.5s ease-out' }}>
        ...
        <div>
          <h1 style={{ fontSize: '28px', fontWeight: '600', color: 'var(--text-primary)' }}>Cadastrar novo aviamento</h1>
      ...
      <section className="settings-container" style={{ display: 'block' }}>
        <div className="settings-card" style={{ maxWidth: '700px' }}>
          <form className="settings-form" onSubmit={(e) => { e.preventDefault(); alert('Aviamento salvo com sucesso!'); navigate(-1); }}>
            
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <label>Tipo de aviamento *</label>
              <input type="text" placeholder="Ex: Botão, Zíper, Linha" required />
            </div>

            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label>Cor</label>
                <input type="text" placeholder="Ex: Branco" required />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label>Peso/Quantidade</label>
                <input type="text" placeholder="Ex: 500 unidades" required />
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <input type="text" placeholder="Ex: Plástico" required />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label>Fabricante</label>
                <input type="text" placeholder="Ex: Fornecedor A" required />
              </div>
            </div>
